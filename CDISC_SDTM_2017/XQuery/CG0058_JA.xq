...
for $itemgroupdef in $definedoc//odm:ItemGroupDef
    ...
    return <error rule="CG0058" variable="{data($entptname)}" dataset="{$name}" rulelastupdate="2017-02-05">{data($entptname)} is not present although {data($enrtptname)} is present</error>	
