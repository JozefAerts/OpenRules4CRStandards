...
for $itemgroupdef in $definedoc//odm:ItemGroupDef
    ...
    return <error rule="CG0062" variable="{data($sttptname)}" dataset="{$name}" rulelastupdate="2017-02-05">{data($sttptname)} is not present although {data($strtptname)} is present</error>				
