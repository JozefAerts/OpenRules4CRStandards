...
for $group in $orderedrecords
        ...
        for $record in $group[$recordcount>1]/odm:ItemGroupData 
            ...
            return <error rule="CG0063" variable="EPOCH" dataset="DS" rulelastupdate="2017-02-05" recordnumber="{data($recnum)}">EPOCH is missing for multiple DSCAT='DISPOSITION EVENT' occurrence for subject {data($usubjid)}</error>			
