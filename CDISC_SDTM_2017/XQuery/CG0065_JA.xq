...
for $record in $dsdatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$dstermoid and @Value='COMPLETED']]
    ...
    return <error rule="CG0065" variable="DSDECOD" dataset="DS" rulelastupdate="2017-02-06" recordnumber="{data($recnum)}">The value of DSDECOD is not 'COMPLETED' although the value of DSTERM='COMPLETED'. Value found for DSDECOD='{data($dsdecodvalue)}'</error>			
