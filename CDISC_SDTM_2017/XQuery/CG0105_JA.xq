...
for $itemgroupdef in $definedoc//odm:ItemGroupDef[@Domain='EX' or starts-with(@Name,'EX')]
    ...
    return 
        <error rule="CG0105" dataset="{data($name)}" variable="EXVAMT" rulelastupdate="2017-02-12">EXVAMT is present in dataset although the EC domain/dataset is present</error>
