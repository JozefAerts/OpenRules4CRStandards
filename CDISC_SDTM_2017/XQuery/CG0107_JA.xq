...
for $itemgroupdef in $definedoc//odm:ItemGroupDef[@Domain='EX' or starts-with(@Name,'EX')]
    ...
    return 
        <error rule="CG0107" dataset="{data($name)}" variable="EXVAMTU" rulelastupdate="2017-02-11">EXVAMTU is present in dataset although the EC domain/dataset is present</error>			
