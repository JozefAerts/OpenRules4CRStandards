...
for $record in $dmdatasetdoc//odm:ItemGroupData
    ...
    return <error rule="CG0142" variable="RFENDTC" dataset="DM" rulelastupdate="2017-02-18" recordnumber="{data($recnum)}">RFENDTC=null for ACTARM='{data($actarmvalue)}'. RFENDTC is required for all randomized subjects.</error>			
