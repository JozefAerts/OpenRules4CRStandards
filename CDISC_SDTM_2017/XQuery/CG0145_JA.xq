...
for $record in $dmdatasetdoc//odm:ItemGroupData
    ...
    return <error rule="CG0145" variable="RFSTDTC" dataset="DM" rulelastupdate="2017-02-19" recordnumber="{data($recnum)}">RFSTDTC='{data($rfstdtcvalue)}' expected to be null for ACTARM='{data($actarmvalue)}'</error>						
