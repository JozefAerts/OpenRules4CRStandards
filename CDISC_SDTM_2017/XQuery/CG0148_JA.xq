...
for $dmrecord in $dmdatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$rfxstdtcoid]]
    ...
    return <error rule="CG0148" variable="RFXENDTC" dataset="DM" rulelastupdate="2017-02-19" recordnumber="{data($recnum)}">RFXSTDTC='{data($rfxstdtc)}' does not correspond to the earliest exposure EXSTDTC='{data($earliestexstdtc)}' value</error>				
