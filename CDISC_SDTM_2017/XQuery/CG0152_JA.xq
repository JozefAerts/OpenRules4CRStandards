...
for $record in $sedatasetdoc//odm:ItemGroupData
    ...
    return <error rule="CG0152" dataset="SE" variable="ELEMENT" rulelastupdate="2019-08-29" recordnumber="{data($recnum)}">Invalid value for ELEMENT={data($element)}, null was expected for ETCD='UNPLAN'</error>			
