...
for $record in $codatasetdoc//odm:ItemGroupData[not(odm:ItemData[@ItemOID=$rdomainoid])]
    ...
    return <error rule="CG0164" dataset="CO" variable="IDVAR" rulelastupdate="2017-02-20" recordnumber="{data($recnum)}">IDVAR={data($idvar)} is populated although RDOMAIN=null</error>			
