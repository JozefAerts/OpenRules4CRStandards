...
for $record in $codatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$idvaroid and @Value]]
    ...
    return <error rule="CG0166" dataset="CO" variable="CODTC" rulelastupdate="2017-02-20" recordnumber="{data($recnum)}">IDVAR={data($idvar)} but a value for CODTC={data($codtc)} was found</error>			
