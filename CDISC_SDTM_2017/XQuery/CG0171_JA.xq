...
for $record in $ssdatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$ssstresc and @Value='DEAD']]
    ...
    return <error rule="CG0171" variable="SSDTC" dataset="SS" recordnumber="{data($recnumss)}" rulelastupdate="2017-02-20">SSDTC={data($ssdtc)} is not before or equal to DM.DTHDTC={data($dthdtc)} for SSSTRESC='DEAD'</error>			
