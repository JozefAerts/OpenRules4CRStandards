...
for $record in doc($iedatasetlocation)//odm:ItemGroupData
    ...
    return <error rule="CG0175" variable="IEORRES" rulelastupdate="2017-02-20" recordnumber="{data($recnum)}" dataset="IE" variable="IEORRES">For IECAT='EXCLUSION', IEORRES must be 'Y' but {data($ieorresvalue)} was found</error>			
