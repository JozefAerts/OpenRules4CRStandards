...
for $record in doc($iedatasetlocation)//odm:ItemGroupData
    ...
    return <error rule="CG0176" variable="IEORRES" rulelastupdate="2017-02-20" recordnumber="{data($recnum)}" dataset="IE" variable="IEORRES">For IECAT='INCLUSION', IEORRES must be 'N' but {data($ieorresvalue)} was found</error>			
