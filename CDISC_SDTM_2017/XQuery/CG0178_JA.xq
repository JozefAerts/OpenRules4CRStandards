...
for $record in $iedatasetdoc//odm:ItemGroupData
    ...
    return <error rule="CG0178" dataset="IE" variable="IETEST" rulelastupdate="2017-02-20" recordnumber="{data($recnum)}">Value of IE.IETEST={data($ieietest)} cannot be found in the TI dataset</error>				
