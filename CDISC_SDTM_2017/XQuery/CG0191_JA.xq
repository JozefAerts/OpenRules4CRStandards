...
(: when the MB dataset exists, also the MB document must exist :)
where doc-available($msdatasetdoc) and not(doc-available($mbdatasetdoc))
return <error rule="CG0191" dataset="MS" rulelastupdate="2017-02-21">MB dataset exists, but MS dataset is missing</error>				
