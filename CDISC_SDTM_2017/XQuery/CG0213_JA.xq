...
for $record in $svdatasetdoc//odm:ItemGroupData[not(odm:ItemData[@ItemOID=$svupdesoid])]
    ...
    return <error rule="CG0213" dataset="SV" variable="VISITNUM" rulelastupdate="2017-02-24" recordnumber="{data($recnum)}">SV.VISITNUM={data($svvisitnum)} was not found in TV for SVUPDES=null</error>						
