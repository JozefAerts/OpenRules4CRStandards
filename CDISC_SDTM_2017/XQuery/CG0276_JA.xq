...
for $itemgroup in doc(concat($base,$define))//odm:ItemGroupDef[@Name='TS']
    ...
    return <error rule="CG0276" dataset="TS" variable="TSVAL" rulelastupdate="2017-02-26">Null value for TSVAL for TSPARMCD='TRT' found although a record with TSPARMCD='STYPE and TSVAL='INTERVENTIONAL' exists</error>			
