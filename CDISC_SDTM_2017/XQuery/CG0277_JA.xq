...
for $itemgroup in doc(concat($base,$define))//odm:ItemGroupDef[@Name='TS']
    ...
    return <error rule="CG0277" dataset="TS" variable="TSVAL" rulelastupdate="2017-02-27">Null value for TSVAL for TSPARMCD='INTMODEL' found although a record with TSPARMCD='STYPE and TSVAL='INTERVENTIONAL' exists</error>		
