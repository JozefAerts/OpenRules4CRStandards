...
for $itemgroupdef in $definedoc//odm:ItemGroupDef
    ...
    return <error rule="CG0311" dataset="{data($name)}" variable="{data($varname)}" rulelastupdate="2017-03-06">The variable label '{data($label)}' for variable '{data($varname)}' has more than 40 characters</error>							
