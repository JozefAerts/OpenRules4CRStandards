...
(: iterate over all datasets definitions provided that are in the general observation classes:
INTERVENTIONS, FINDINGS, EVENTS :)
for $itemgroupdef in $definedoc//odm:ItemGroupDef[@def:Class='INTERVENTIONS' or @def:Class='FINDINGS' or @def:Class='EVENTS'][@Name=$datasetname]
    ...
    return <error rule="CG0313" dataset="{data($name)}" rulelastupdate="2019-08-12">One of the required identifier variables STUDYID, USUBJID/POOLID, DOMAIN, or --SEQ is missing</error>							
