...
for $taitemgroupdef in $definedoc//odm:ItemGroupDef[starts-with(@Name,'FA')]
    ...
    return <error rule="CDG0330" dataset="{data($name)}" rulelastupdate="2017-03-11">No corresponding dataset or domain '{data($aboutdomain)}' was found for Findings About dataset '{data($name)}'</error>			
