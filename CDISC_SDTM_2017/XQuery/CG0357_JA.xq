...
let $dmitemgroupdef := $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    where $strainoid
    return <error rule="CG0357" dataset="DM" variable="STRAIN" rulelastupdate="2017-03-14">The use of the variable 'STRAIN' is not allowed in SDTM domain 'DM' (it is specific to SEND)</error>			
