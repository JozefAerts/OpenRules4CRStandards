...
let $dmitemgroupdef := $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    where $sbstrainoid
    return <error rule="CG0358" dataset="DM" variable="SBSTRAIN" rulelastupdate="2017-03-14">The use of the variable 'SBSTRAIN' is not allowed in SDTM domain 'DM' (it is specific to SEND)</error>			
