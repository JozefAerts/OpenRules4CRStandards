...
for $itemgroupdef in $definedoc//odm:ItemGroupDef
    ...
    return <error rule="CG0468" dataset="{data($name)}" variable="" rulelastupdate="2017-03-25">Variable {data($tptnumname)} is absent although {data($tptname)} is present</error>													
