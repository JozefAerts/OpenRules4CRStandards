...
let $aeoccur := (
    ...
    where $aeoccur
    return 
     <error rule="CG0040" rulelastupdate="2020-06-11" dataset="AE" variable="AEOCCUR">AEOCCUR is not allowed in AE because the AE domain contains only records for adverse events that actually occurred</error>			
