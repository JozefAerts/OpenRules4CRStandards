...
where $count < 2
return <error rule="CG0077" variable="MHCAT" dataset="MH" rulelastupdate="2020-06-11">Only {data($count)} distinct value '{data($mhcatdistinctvalues)}' values for MHCAT was found in the {data($name)} dataset</error>		
