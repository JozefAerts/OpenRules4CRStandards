...
for $dataset in $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in doc($datasetlocation)//odm:ItemGroupData[odm:ItemData[@ItemOID=$actarmoid]]
        ...
        return <error rule="CG0118" dataset="DM" variable="ACTARM" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">Invalid value for ACTARM, value={data($actarmvalue)} is not one of ('Screen Failure', 'Not Assigned', 'Not Treated', 'Unplanned Treatment') and is not found in TA</error>						
