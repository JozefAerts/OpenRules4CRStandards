...
for $record in $dmdatasetdoc//odm:ItemGroupData
    ...
    return <error rule="CG0146" variable="RFSTDTC" dataset="DM" rulelastupdate="2020-06-14" recordnumber="{data($recnum)}">RFSTDTC expected to be not null for ACTARM='{data($actarmvalue)}'</error>			
