...
for $dmrecord in $dmdatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$setcdoid]]
    ...
    return <error rule="CG0149" variable="SETCD" dataset="DM" rulelastupdate="2020-06-14" recordnumber="{data($recnum)}">SETCD='{data($setcdvalue)}' has more than 8 characters</error>				
