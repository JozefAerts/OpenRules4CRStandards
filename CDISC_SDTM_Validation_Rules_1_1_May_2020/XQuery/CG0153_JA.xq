...
let $datasets := $definedoc//odm:ItemGroupDef[@Name='DM' or @Name='TA']
...
for $dataset in $datasets
    ...
    return <error rule="CG0153" dataset="{data($name)}" variable="ARMCD" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">Invalid value for ARMCD={data($armcdvalue)} in dataset {data($datasetname)} - it has more than 20 characters</error>			
