...
for $record in $codatasetdoc[$rdomainoid and $idvaroid]//odm:ItemGroupData
    ...
    return <warning rule="CG0163" dataset="CO" variable="IDVAR" recordnumber="{data($recnum)}" rulelastupdate="2020-06-14">IDVAR must be null, value '{data($idvar)}' was found, as value for RDOMAIN is null or 'DM'</warning>
