...
(: Rule CG0166 - CO domain - When IDVARVAL != null then RDOMAIN != null :)
xquery version "3.0";
...
for $record in $codatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$idvarvaloid and @Value]]
    ...
    return <error rule="CG0166" dataset="CO" variable="RDOMAIN" rulelastupdate="2020-06-14" recordnumber="{data($recnum)}">IDVARVAL={data($idvarval)} but RDOMAIN=null</error>			
