...
for $record in $iedatasetlocation//odm:ItemGroupData
    ...
    return <error rule="CG0175" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}" dataset="IE" variable="IEORRES">For IECAT='EXCLUSION', IEORRES must be 'Y' but {data($ieorresvalue)} was found</error>			
