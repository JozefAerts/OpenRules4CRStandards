...
for $record in $mbdatasetdoc[$mbtestcdoid]//odm:ItemGroupData[odm:ItemData[@ItemOID=$mbtestcdoid and @Value='ORGANISM'] 
    ...
    return <error rule="CG0193" dataset="MB" variable="MBRESCAT" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">MBTESTCD='ORGANISM' and MBSTRESC!='NO GROWTH' and MBMETHOD!='GRAM STAIN' but MBRESCAT=null</error>	
