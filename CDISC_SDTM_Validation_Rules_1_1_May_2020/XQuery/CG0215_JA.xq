...
for $record in $svdatasetdoc//odm:ItemGroupData[not(odm:ItemData[@ItemOID=$svupdesoid])]
    ...
    return <error rule="CG0215" dataset="SV" variable="VISIT" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">SV.VISIT='{data($svvisit)}' was not found in TV for SVUPDES=null</error>		
