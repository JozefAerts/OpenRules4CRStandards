...
(: Rule CG0219 - INTERVENTIONS, EVENTS, FINDINGS (except for IE,SC) - At least one timing variable present in dataset :)
(: TODO: Timing variables for SDTM 1.7 :)
xquery version "3.0";
...
for $itemgroupdef in $definedoc//odm:ItemGroupDef[upper-case(@def:Class)='INTERVENTIONS' or upper-case(@def:Class)='EVENTS' or upper-case(@def:Class)='FINDINGS'][not(@Name='SC' or @Name='IE')]
