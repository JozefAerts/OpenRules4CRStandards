...
for $itemgroup in $definedoc//odm:ItemGroupDef[@Name='TS']
    ...
    return <error rule="CG0275" dataset="TS" variable="TSVAL" rulelastupdate="2020-08-04">Null value for TSVAL for TSPARMCD='CURTRT' found although a record with TSPARMCD='ADDON and TSVAL='Y' exists</error>			
