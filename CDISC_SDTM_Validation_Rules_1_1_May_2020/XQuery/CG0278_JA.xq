...
for $itemgroup in $definedoc//odm:ItemGroupDef[@Name='TS']
    ...
    return <error rule="CG0278" dataset="TS" variable="TSVAL" rulelastupdate="2020-08-04">Null value for TSVAL for TSPARMCD='INTTYPE' found although a record with TSPARMCD='STYPE and TSVAL='INTERVENTIONAL' exists</error>			
