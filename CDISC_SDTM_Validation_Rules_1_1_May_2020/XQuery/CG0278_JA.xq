...
for $itemgroup in doc(concat($base,$define))//odm:ItemGroupDef[@Name='TS']
    ...
    return <error rule="CG0278" dataset="TS" variable="TSVAL" rulelastupdate="2020-06-15">Null value for TSVAL for TSPARMCD='INTTYPE' found although a record with TSPARMCD='STYPE and TSVAL='INTERVENTIONAL' exists</error>			
