...
for $tvitemgroupdef in $definedoc//odm:ItemGroupDef[@Name='TV']
    ...
    for $record in $tvdatasetdoc//odm:ItemGroupData
        ...
        return <error rule="CG0297" dataset="TV" variable="ARM" recordnumber="{data($recnum)}" rulelastupdate="2020-08-04">TV.ARMCD='{data($tvarmcd)}' has more than 20 characters</error>											
