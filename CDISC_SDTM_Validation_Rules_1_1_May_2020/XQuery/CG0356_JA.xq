...
let $dmitemgroupdef := $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    where $speciesoid
    return <error rule="CG0356" dataset="DM" variable="SPECIES" rulelastupdate="2020-08-04">The use of the variable 'SPECIES' is not allowed in SDTM domain 'DM' (it is specific to SEND)</error>			
