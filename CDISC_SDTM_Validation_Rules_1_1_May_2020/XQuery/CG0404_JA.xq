...
for $itemgroupdef in $definedoc//odm:ItemGroupDef[upper-case(@def:Class)='EVENTS' or upper-case(@def:Class)='INTERVENTIONS' 
		or upper-case(./def21:Class/@Name)='EVENTS' or upper-case(./def21:Class/@Name)='INTERVENTIONS'][not(starts-with(@Name,'AE') or starts-with(@Name,'DS') or starts-with(@Name,'DV') or starts-with(@Name,'EX'))]
