...
for $dataset in doc(concat($base,$define))//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in doc($datasetlocation)//odm:ItemGroupData[odm:ItemData[@ItemOID=$ageuoid]]
        ...
        return <error rule="CG0433" dataset="DM" variable="AGE" rulelastupdate="2020-06-19" recordnumber="{data($recnum)}">AGE=null where AGETXT=null and AGEU='{data($ageuvalue)}' is not null</error>				
