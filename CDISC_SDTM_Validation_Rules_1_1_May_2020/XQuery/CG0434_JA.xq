...
for $dataset in doc(concat($base,$define))//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in doc($datasetlocation)//odm:ItemGroupData[odm:ItemData[@ItemOID=$ageuoid]]
        ...
        return <error rule="CG0434" dataset="DM" variable="AGE" rulelastupdate="2020-06-19" recordnumber="{data($recnum)}">AGETXT=null where AGE=null and AGEU='{data($ageuvalue)}' is not null</error>				
