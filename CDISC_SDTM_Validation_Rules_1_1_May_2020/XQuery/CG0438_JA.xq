...
return <error rule="CG0438" dataset="TS" variable="TSVAL" rulelastupdate="2020-06-19" recordnumber="{data($tsageminrecordnumber)}">Invalid (non-ISO8601) TSVAL value={data($tsvalvalue)} for AGEMIN in dataset TS</error>				
