...
(: we need to take the week format PnnW / -PnnW into account :)
...
return <error rule="CG0439" dataset="TS" variable="TSVAL" rulelastupdate="2020-08-04" recordnumber="{data($lengthrecordnumber)}">Invalid (non-ISO8601) TSVAL value={data($tsvalvalue)} for LENGTH in dataset TS</error>	
