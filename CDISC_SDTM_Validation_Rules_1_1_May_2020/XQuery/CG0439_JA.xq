...
return <error rule="CG0439" dataset="TS" variable="TSVAL" rulelastupdate="2020-06-19" recordnumber="{data($lengthrecordnumber)}">Invalid (non-ISO8601) TSVAL value={data($tsvalvalue)} for LENGTH in dataset TS</error>				
