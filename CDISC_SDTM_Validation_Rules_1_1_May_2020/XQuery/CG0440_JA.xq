...
return <error rule="CG0440" rulelastupdate="2020-06-19" dataset="TS" variable="TSVAL" recordnumber="{data($tsageminrecordnumber)}">Invalid TSVAL value for PLANSUB, value={data($tsvalvalue)} in dataset TS</error>				
