...
for $record in $tsdatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$tsparmcdoid]][1]
    ...
    :)
    where $uniicount=0
    return <error rule="CG0445" dataset="TS" variable="TSVAL" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">Invalid TSVAL value={data($tsvalvalue)} for TSPARMCD=COMPTRT in dataset TS</error>
