...
for $pclassrecord in $tsdatasetdoc//odm:ItemGroupData[1]
    ...
    for $tsvalcdvalue in $tsvalcdvalues
	    ...
	    return <error rule="CG0454" dataset="TS" variable="TSVALCD" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">Invalid TSVALCD value={data($tsvalcdvalue)} for TSPARMCD=PCLAS</error>			
