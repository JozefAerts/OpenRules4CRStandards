...
for $pclassrecord in doc($tsdatasetlocation)//odm:ItemGroupData[1]
    ...
    for $tsvalcdvalue in $tsvalcdvalues
	    ...
	    return <error rule="CG0454" dataset="TS" variable="TSVALCD" rulelastupdate="2020-06-19" recordnumber="{data($recnum)}">Invalid TSVALCD value={data($tsvalcdvalue)} for TSPARMCD=PCLAS</error>			
