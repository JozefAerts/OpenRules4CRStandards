...
for $record in $tsdatasetdoc//odm:ItemGroupData[odm:ItemData[@ItemOID=$tsparmcdoid and @Value='PCLAS']]
    ...
    return <error rule="CG0455" dataset="TS" variable="TSVCDREF" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">Invalid TSVCDREF value={data($tsvcdrefvalue)} for TSPARMCD=PCLAS. The value must be 'NDF-RT'</error>				
