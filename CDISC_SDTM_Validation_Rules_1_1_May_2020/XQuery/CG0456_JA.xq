...
for $record in doc($tsdatasetlocation)//odm:ItemGroupData[odm:ItemData[@ItemOID=$tsparmcdoid and @Value='FCNTRY']]
    ...
    return <error rule="CG0456" dataset="TS" variable="TSVCDREF" rulelastupdate="2020-06-19" recordnumber="{data($recnum)}">Invalid TSVCDREF value={data($tsvcdrefvalue)} for FCNTRY. The value must be 'ISO 3166-1 alpha-3'</error>		
