...
return <error rule="CG0457" dataset="TS" variable="TSVAL" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">Invalid TSVAL value '{data($actsubval)}' for Trial Summary Parameter TSPARMCD=ACTSUB in dataset {data($tsdatasetname)}</error>	
