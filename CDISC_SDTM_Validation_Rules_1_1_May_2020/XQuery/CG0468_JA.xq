...
for $itemgroupdef in $definedoc//odm:ItemGroupDef
    ...
    return <error rule="CG0468" dataset="{data($name)}" variable="" rulelastupdate="2020-06-19">Variable {data($tptnumname)} is absent although {data($tptname)} is present</error>													
