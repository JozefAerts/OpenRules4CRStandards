...
for $dataset in $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in doc($datasetlocation)//odm:ItemGroupData[not(odm:ItemData[@ItemOID=$actarmcdoid])]
        ...
        return <error rule="CG0513" dataset="DM" variable="ACTARMCD" rulelastupdate="2020-06-21" recordnumber="{data($recnum)}">ARMNRS is not populated although ACTARMCD is null</error>
