...
for $dataset in $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in $datasetdoc//odm:ItemGroupData[not(odm:ItemData[@ItemOID=$actarmoid])]
        ...
        return <error rule="CG0515" dataset="DM" variable="ACTARM" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">ARMNRS is not populated although ACTARM is null</error>	
