...
for $dataset in $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in $datasetdoc//odm:ItemGroupData[not(odm:ItemData[@ItemOID=$armcdoid])]
        ...
        return <error rule="CG0517" dataset="DM" variable="ARMCD" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">ARMNRS is not populated although ARMCD is null</error>	
