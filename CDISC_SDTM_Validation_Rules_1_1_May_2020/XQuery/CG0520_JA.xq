...
for $dataset in $definedoc//odm:ItemGroupDef[@Name='DM']
    ...
    for $record in doc($datasetlocation)//odm:ItemGroupData[odm:ItemData[@ItemOID=$armcdoid] and odm:ItemData[@ItemOID=$actarmcdoid]]
        ...
        where $armnrsvalue
        return <error rule="CG0520" dataset="DM" variable="ARM" rulelastupdate="2020-06-21" recordnumber="{data($recnum)}">ARMNRS is populated although values for ACTARMCD '{}' and ACTARM '' are not null</error>	
