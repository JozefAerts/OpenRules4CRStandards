...
for $record in $dmdatasetdoc//odm:ItemGroupData
    ...
    return <error rule="CG0529" variable="RFENDTC" dataset="DM" rulelastupdate="2020-08-04" recordnumber="{data($recnum)}">RFENDTC=null for ARM='{data($armvalue)}'. RFENDTC is required for all randomized subjects.</error>				
