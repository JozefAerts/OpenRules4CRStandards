...
for $dataset in doc(concat($base,$define))//odm:ItemGroupDef[@Name=$datasetname][@Domain='EG' or @Domain='LB' or @Domain='MB' or @Domain='MS' or @Domain='PC' or @Domain='VS'] (: provides a list of nodes :)
