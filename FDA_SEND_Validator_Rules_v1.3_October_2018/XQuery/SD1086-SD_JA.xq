...
for $dataset in doc(concat($base,$define))//odm:ItemGroupDef[@Name=$datasetname][not(@Name='DM')][upper-case(@def:Class)='INTERVENTIONS' or upper-case(@def:Class)='EVENTS' or upper-case(@def:Class)='FINDINGS'] 
