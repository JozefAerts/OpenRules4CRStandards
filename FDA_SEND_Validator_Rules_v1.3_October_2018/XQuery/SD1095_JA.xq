...
for $itemgroup in doc(concat($base,$define))//odm:ItemGroupDef[@Domain][upper-case(@def:Class)='INTERVENTIONS' or upper-case(@def:Class)='FINDINGS' or upper-case(@def:Class)='EVENTS']
